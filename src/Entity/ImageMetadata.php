...
#[ORM\Entity(repositoryClass: \App\Repository\ImageMetadataRepository::class)]
#[ORM\Table(name: 'ImageMetadata')]
class ImageMetadata implements \Stringable
{
    #[ORM\OneToOne(targetEntity: \App\Entity\Image::class, inversedBy: 'meta')]
