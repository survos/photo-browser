...
#[ORM\Entity(repositoryClass: \App\Repository\ImagePropertiesRepository::class)]
#[ORM\Table(name: 'ImageProperties')]
class ImageProperties implements \Stringable
{
    ...
    #[ORM\Id]
    #[ORM\OneToOne(targetEntity: \App\Entity\Image::class)]
